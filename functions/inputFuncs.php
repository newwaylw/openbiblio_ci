...
/**
 *  This function works exactly like printSelect except that it enables
 *  the first "All" option.
 *  W. Liu
 */
function printSelectWithAll($fieldName,$domainTable,&$postVars,$disabled=FALSE){
  $_SESSION['postVars'] = $postVars;
  $attrs = array();
  if ($disabled) {
    $attrs['disabled'] = '1';
  }
  echo dmSelect($domainTable, $fieldName, "", TRUE, $attrs);
}
