...
<table class="primary">
<tr>
<td><img height="150" width="100" src="<?php echo  UPLOAD_DIR . $biblio->getImageLocation(); ?>"> </td>
<td>
<table class="primary">
  <tr>
  ...
  <!-- call number, aka shelfmark, now moved to above copy details
  <tr>
  ...
  -->
  <!--  w.liu edit: no point showing this 
  <tr>
    <td nowrap="true" class="primary" valign="top">
...
<p class="newcolor" > <?php echo $loc->getText("biblioViewTble2Hdr"); ?>: </p>
<table class="primary">
<tr>
    <td align="top">
      <?php echo $loc->getText("biblioViewCallNmbr"); ?>:
...
<table class="sample">
  <tr>
    ...
    <th align="left" nowrap="yes">
      <?php echo $loc->getText("biblioViewTble2Col2"); ?> &nbsp(Location)
    </th>
    <th align="left" nowrap="yes">
...
<!-- a href='javascript:history.go(-1)'>Back 返回上一页 </a -->
<FORM>
  <p align=center>
 <!-- <INPUT TYPE="button" VALUE="Back 返回上一页" onClick="history.go(-1);return true;"> -->
  <button style="width:140;height:35;background-color:grey" onClick="history.go(-1)"><b>Back 返回上一页</b></button>
  </p>
</FORM>
