...
?>
  ...
  <tr>
        <td class="primary" nowrap="true" valign="top">
            Language
        </td>
        <td class="primary" valign="top">
          <?php printInputText("language",20,90,$postVars,$pageErrors); ?>
        </td>
   </tr>
   <tr>
        <td class="primary" nowrap="true" valign="top">
        ...
        <td class="primary" valign="top">
          <?php printInputText("othernumber",20,20,$postVars,$pageErrors); ?>
        </td>
   </tr>
  <tr>
...
<script type="text/javascript">
  ...
  <tr>
        <td class="primary" nowrap="true" valign="top">
           Image: <?php echo ($postVars["image"]) ?>
        </td>
        <td>
          <input name="input_upload" type='file' onchange="readURL(this);" />
          <input type="hidden" name="image" value= " <?php echo ($postVars["image"]) ?> " />
          <img name='cover_image' id="image" src=<?php echo (UPLOAD_DIR . DEFAULT_IMAGE) ?> alt="cover_image" height="128" width="128"/>
        </td>
        <!--
        <td class="primary" valign="top">
          <form enctype="multipart/form-data" name="form1"  method="POST" action="upload.php"  target="frame1">
           <input name="input_upload" id="uFile" type="file"/>
           <input id="uSubmit" name="submit" value="Upload" type="submit""/> </br>
           <iframe id="frame1" name="frame1" style="width:300;height:70;border:0px solid #fff;"></iframe>
           </form>
           <input name="uploadin" id="uploadin" type="hidden"/>
        </td>
        -->
   </tr>
